    ...
    <div className="min-h-screen bg-dark text-white">
      ...
      <section id="home" className="relative overflow-hidden">
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-dark via-dark/85 to-navy/80" />
        </div>
      ...
      <section id="about" className="py-24 bg-black">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 grid gap-12 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <Button className="mt-8 px-8 py-4 rounded-full font-semibold shadow-[0_12px_32px_rgba(212,175,55,0.33)]">
          ...
          <div className="mt-16 grid gap-8 lg:grid-cols-2">
            <Card className="bg-black/85 border border-white/10 text-neutral-light shadow-[0_25px_45px_rgba(13,13,13,0.45)]">
              ...
              <CardContent className="pt-0 space-y-6 text-left">
                ...
                <Button className="rounded-full px-8 py-4 font-semibold shadow-[0_12px_32px_rgba(212,175,55,0.33)]">
                  See Consulting Approach →
                  <ArrowRight className="ml-3 h-5 w-5" />
                </Button>
              </CardContent>
            </Card>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-16 space-y-8">
            {caseStudies.map((item) => (
              <div key={item.title} className="group relative overflow-hidden rounded-3xl border border-white/10 bg-dark-900/70">
                <div className="relative h-64 w-full overflow-hidden">
                  ...
                  <div className="absolute bottom-6 left-6">
                    <p className="text-xs uppercase tracking-[0.3em] text-accent">{item.title}</p>
                    <p className="mt-2 text-2xl font-semibold text-white">{item.headline}</p>
                  </div>
                </div>
                <div className="flex flex-col gap-3 px-6 py-6 sm:flex-row sm:items-center sm:justify-between">
                  <div className="flex flex-wrap gap-4">
                    {item.metrics.map((metric) => (
                      <span key={metric} className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm text-neutral-light/80">
                        <Target className="h-4 w-4 text-accent" />
                        {metric}
                      </span>
                    ))}
                  </div>
                  <Button variant="outline" className="mt-4 w-full rounded-full border-white/15 text-white hover:text-dark hover:bg-neutral-lighter sm:mt-0 sm:w-auto">
                    View Case Study
                  </Button>
                </div>
              </div>
            ...
            {pricingTiers.map((tier) => (
              <Card key={tier.name} className="bg-black border-white/10 text-neutral-light">
                ...
                <div className="px-6 pb-6">
                  <Button className="w-full rounded-full px-6 py-3 font-semibold shadow-[0_10px_30px_rgba(212,175,55,0.32)]">
                    Book a Consultation
                  </Button>
                </div>
              </Card>
      ...
      <section id="final-cta" aria-labelledby="final-cta-title">
        <div className="final-cta__container">
          <p className="final-cta__kicker">Your Growth &amp; Influence, Engineered</p>
          <h1 id="final-cta-title" className="final-cta__headline">Let’s Build the System That Drives Your Next Stage of Growth.</h1>
          ...
          <div className="cta-vignette">
            <div className="cta-row">
              <button className="btn btn-primary" aria-label="Request your strategic audit" data-cta="audit">
                Request Your Strategic Audit
              </button>
              <button className="btn btn-secondary" aria-label="Apply for partnership" data-cta="partnership">
                Apply for Partnership
              </button>
            </div>
          </div>
          <p className="microtrust">
            <span className="lock" aria-hidden="true">🔒</span> Free audit. No obligation.
            <a href="mailto:contact@swiftnexus.com" className="alt">Prefer email? contact@swiftnexus.com</a>
          </p>
        </div>
      </section>
